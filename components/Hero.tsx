    ...
    >
      ...
      <div className="flex flex-col items-start text-left max-w-2xl w-full">
        <div className="relative mb-2 md:mb-6">
          ...
          <h1 className="text-4xl md:text-9xl font-black tracking-tighter leading-none uppercase relative z-10 flex flex-col items-start">
            <span className="text-[#FF00FF]">Rahul</span>
            <span className="bg-black text-[#39FF14] px-1 md:px-4 mt-0.5 md:-ml-4 inline-block transform -rotate-1">Hari</span>
          </h1>
        </div>
        ...
        <div className="border-l-[2px] md:border-l-8 border-black pl-2 md:pl-6 py-1 md:py-2 flex flex-col gap-1.5 md:gap-6 items-start">
          ...
          >
            ...
            <motion.svg
              ...
              width="10" height="10" md:width="24" md:height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4"
            >
